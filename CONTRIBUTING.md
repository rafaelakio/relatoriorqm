...
- Verifique se o bug já não foi reportado nas [Issues](https://github.com/rafaelakio/relatoriorqm/issues)
- Se não encontrar, [crie uma nova issue](https://github.com/rafaelakio/relatoriorqm/issues/new?template=bug_report.md)
...
- Verifique se a sugestão já não existe nas [Issues](https://github.com/rafaelakio/relatoriorqm/issues)
- [Crie uma nova issue](https://github.com/rafaelakio/relatoriorqm/issues/new?template=feature_request.md)
...
- Abra uma [Discussion](https://github.com/rafaelakio/relatoriorqm/discussions)
- Entre em contato via [Issues](https://github.com/rafaelakio/relatoriorqm/issues)
